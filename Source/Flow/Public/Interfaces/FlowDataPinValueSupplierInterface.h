...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Can Supply DataPin Values")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Int")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Float")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Name")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As String")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Text")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Enum")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Vector")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As Transform")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As GameplayTag")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "FlowNode", DisplayName = "Try Supply DataPin As GameplayTagContainer")
