...
void UFlowK2SchemaSubclassForAccess::AssertPinCategoryNames()
{
	...
	checkf(FFlowPin::PC_Real == UEdGraphSchema_K2::PC_Real, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_Name == UEdGraphSchema_K2::PC_Name, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_Delegate == UEdGraphSchema_K2::PC_Delegate, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_MCDelegate == UEdGraphSchema_K2::PC_MCDelegate, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_Object == UEdGraphSchema_K2::PC_Object, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_Interface == UEdGraphSchema_K2::PC_Interface, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	...
	checkf(FFlowPin::PC_Wildcard == UEdGraphSchema_K2::PC_Wildcard, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
	checkf(FFlowPin::PC_FieldPath == UEdGraphSchema_K2::PC_FieldPath, TEXT("Flow PC_* aliases should match Epic's K2 PC_* names exactly"));
